...
CREATE TABLE `login_session`.`usuario` ( 
`id` INT NOT NULL , 
`nome` VARCHAR(100) NOT NULL , 
`email` VARCHAR(100) NOT NULL , 
`senha` VARCHAR(100) NOT NULL , PRIMARY KEY (`id`)) ENGINE = MyISAM;
...
public class ConnectionFactory {
    ...
    private final String url = "jdbc:mysql://localhost:3306/login_session";
